...
class group(models.Model):
    ...
    owner=models.ForeignKey("personal.UserProfile",on_delete=models.DO_NOTHING) 
...
class member(models.Model):
    ...
    memberID=models.ForeignKey("personal.UserProfile",on_delete=models.DO_NOTHING)
...
class articleGroup_category(models.Model):
    articleID=models.ForeignKey("article.article",on_delete=models.DO_NOTHING)
    categoryID=models.ForeignKey("group_category",on_delete=models.DO_NOTHING)
    class Meta:
